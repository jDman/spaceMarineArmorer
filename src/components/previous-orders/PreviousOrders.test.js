...
describe('<PreviousOrders />', () => {
  it('should render component and display button with View previous orders text', () => {
  ...
  it('should render component and display list of orders when showPreviousOrders prop true', () => {
    const component = renderer.create(
      <PreviousOrders
